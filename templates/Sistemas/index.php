 ...
 * @var iterable<\App\Model\Entity\Sistema> $sistemas
 */
?>
<div class="sistemas index content">
    <?= $this->Html->link(__('New Sistema'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Sistemas') ?></h3>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('IdDato') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $this->Number->format($sistema->IdDato) ?></td>
