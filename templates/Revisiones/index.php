 ...
 * @var iterable<\App\Model\Entity\Revisione> $revisiones
 */
?>
<div class="row">
    <aside class="column">
    ...
    <div class="column-responsive column-80">
        <div class="revisiones index content">
            ...
            <h3><?= __('Revisión por Sistemas') ?></h3>
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <?php foreach ($revisiones as $revisione): ?>
                        <tr>
                            <td><?= h($revisione->id) ?></td>
                            <td><?= h($revisione->registro_id) ?></td>
                            <td><?= h($revisione->valor) ?></td>
                            <td><?= h($revisione->sistema->descripcion) ?></td>
                            <td class="actions">
                                <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $revisione->id, $consecutivo], ['confirm' => __('Are you sure you want to delete # {0}?', $revisione->id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <?= $this->Html->link(__('Siguiente'), ['controller' => 'ExamenFisico', 'action' => 'index', $consecutivo],['class' => 'button']) ?>
        </div>
    </div>
</div>