 ...
 * @var iterable<\App\Model\Entity\Analisi> $analisis
 */
?>
<div class="row">
<aside class="column">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $analisi->id, $consecutivo], ['confirm' => __('Are you sure you want to delete # {0}?', $analisi->id)]) ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
